...
const config = {
  ...
  STATUS_READ_MSG: process.env.STATUS_READ_MSG || 'Allan jas viewed your status👌',
  ...
  OWNER_NAME: process.env.OWNER_NAME || "Allan George",
  AUTO_BLOCK: process.env.AUTO_BLOCK || "212,99,90",
  OWNER_NUMBER: process.env.OWNER_NUMBER || "254797450206",
  SUDO_NUMBERS: process.env.SUDO_NUMBERS || "254797450206,254747166551",
